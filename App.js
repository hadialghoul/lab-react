  ...
  return (
    <NavigationContainer >
      ...
      >
        ...
        <Stack.Screen name="activate" component={ActivationScreen} options={{ headerTintColor: '#5DCCBB' }} />
        ...
        <Stack.Screen name="PatientStepsScreen" component={PatientStepsScreen} options={{ title: 'Treatment Steps', headerTintColor: '#5DCCBB' }} />
        ...
        <Stack.Screen name="doctor-patient-steps" component={DoctorPatientSteps} options={{ title: 'Patient Steps', headerTintColor: '#5DCCBB' }} />
        <Stack.Screen name="patient-stage" component={PatientStageScreen} options={{ title: 'Patient Stage', headerTintColor: '#5DCCBB' }} />
        <Stack.Screen name="patient-photos" component={PatientPhotos} options={{ title: 'Photos', headerTintColor: '#5DCCBB' }} />
